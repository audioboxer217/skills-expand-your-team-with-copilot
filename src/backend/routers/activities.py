...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced').
                  Activities with no difficulty set are included for any level since they are open to all.
    """
    ...
    if difficulty:
        # Include activities that match the specified difficulty OR have no difficulty set
